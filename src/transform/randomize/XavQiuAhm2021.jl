...
using Distributions
import ..HPRUCInstance
import ..HPRUCScenario
...
"""
    function randomize!(
        ...
        method = HPRUC.XavQiuAhm2021.Randomization();
        rng = MersenneTwister(),
    )::Nothing
...
```julia
instance = HPRUC.read_benchmark("matpower/case118/2017-02-01")
HPRUC.randomize!(instance)
model = HPRUC.build_model(; instance)
```
