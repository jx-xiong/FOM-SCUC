...
Base.@kwdef mutable struct HPRUCScenario
...
Base.@kwdef mutable struct HPRUCInstance
    time::Int
    scenarios::Vector{HPRUCScenario}
end

function Base.show(io::IO, instance::HPRUCInstance)
    sc = instance.scenarios[1]
    print(io, "HPRUCInstance(")
